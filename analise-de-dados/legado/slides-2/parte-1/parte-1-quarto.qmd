...
author: "Parte 1<br>Introdução à linguagem <code>R</code><br>Gilberto e Carolina"
knitr:
  opts_chunk: 
      echo: true
      results: markup
...
format: 
    revealjs:
        ...
        logo: "ufba.jpg"
        progress: true
        footer: "Apresentando a linguagem <code>R</code>"
        theme: simple
        preview-links: auto
        slide-number: false
...
## Arquivos _formato com comprimento fixo_ (_fixed width format_: _fwf_) {.smaller}
...
* [Número de faltas até o dia 04/09/2022](matc65-mes-9-dia-04-ava.xlsx)
