...
matriz <- paste0("\\#\\#ANSWER", (nlinha * ncol + 1):(2 * nlinha * ncol), "\\#\\#") |>
    matrix(nrow = nlinha, ncol = ncol)
row.names(matriz) <- paste0("A~", 1:nlinha, "~")
kable(
    matriz,
...
&chi;^2^: `r paste0("\\#\\#ANSWER", 2 * nlinha * ncol + 1, "\\#\\#")`.

Coeficiente de contigência modificada: `r paste0("\\#\\#ANSWER", 2 * nlinha * ncol + 2, "\\#\\#")`.

Coeficiente V de Cramer: `r paste0("\\#\\#ANSWER", 2 * nlinha * ncol + 3, "\\#\\#")`.
...
matriz <- sol[(nlinha * ncol + 1):(2 * nlinha * ncol)] |>
    matrix(nrow = nlinha, ncol = ncol)
row.names(matriz) <- paste0("A~", 1:nlinha, "~")
kable(
    matriz,
...
&chi;^2^: `r f(sol[2 * nlinha * ncol + 1])`.

Coeficiente de contigência modificada: `r f(sol[2 * nlinha * ncol + 2])`.

Coeficiente V de Cramer: `r f(sol[2 * nlinha * ncol + 3])`.
