...
Considere amostra com duas variáveis quantitativas contínuas X e Y disponível em [`dados.xlsx`](dados.xlsx). Construa o gráfico de dispersão, calcule o coeficiente de correlação linear de Pearson e encontre o intervalo de confiança para coeficiente de correlação de Pearson (com coeficiente de confiança 95%).

Podemos calcular o coeficiente de correlação linear de Pearson, usamos a função: \#\#ANSWER5\#\#.

Para encontrar a banda (ou intervalo) de confiança para o coeficiente de correlação linear de Pearson, usamos a função: \#\#ANSWER6\#\# .

<hr>

O que podemos dizer sobre a associação entre X e Y?

\#\#ANSWER1\#\#

<hr>

O coeficiente de correlação de linear de Pearson é \#\#ANSWER2\#\#. Além disso, o coeficiente de correlação linear de Pearson está entre \#\#ANSWER3\#\# e \#\#ANSWER4\#\# com coeficiente de confiança 95%. 


Questionlist
------------
* "X e Y estão linear e positivamente associadados."
* "X e Y estão linear e negativamente associadados."
* "X e Y não estão linearmente associados."
* "Não é possível determinar se X e Y estão linearmente associadados."
* 
* 
* 
* 
...
Podemos calcular o coeficiente de correlação linear de Pearson, usamos a função: `cor`.

Para encontrar a banda (ou intervalo) de confiança para o coeficiente de correlação linear de Pearson, usamos a função: `cor.test`.
...
O coeficiente de correlação de linear de Pearson é `r f(sol[1])`. Além disso, o coeficiente de correlação linear de Pearson está entre `r f(sol[2])` e `r f(sol[3])` com coeficiente de confiança 95%. 
...
exname: correlacao
extype: cloze
exclozetype: schoice|num|num|num|string|string
exsolution: `r sol_multipla`|`r sol |> paste(collapse = "|")`|cor|cor.test
extol: 0.05