...
* <br>Pacote que podemos usar para calcular o coeficiente de Goodman-Kruskal:
* <br>Função que podemos usar para calcular o coeficiente de Goodman-Kruskal:
* <br>Número de pares concordantes:
* <br>Número de pares discordantes:
* <br>Coeficiente de Goodman-Kruskal:
