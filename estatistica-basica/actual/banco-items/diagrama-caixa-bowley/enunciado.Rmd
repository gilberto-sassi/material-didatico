...
* O intervalo interquartílico para a variável X é: 
* O coeficiente de bowley para a variável X é: 
* O intervalo interquartílico para a variável Y é: 
* O coeficiente de bowley para a variável Y é: 
* O intervalo interquartílico para a variável Z é: 
* O coeficiente de bowley para a variável Z é: 
