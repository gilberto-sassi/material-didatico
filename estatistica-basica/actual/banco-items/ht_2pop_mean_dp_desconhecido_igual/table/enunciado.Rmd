...
# ajuste
fit_correto <- ht_2pop_mean(amostra1, amostra2, var_equal = T, sig_level = g)
fit_less <- ht_2pop_mean(amostra1, amostra2, var_equal = T, sig_level = g, alternative = "less")
fit_greater <- ht_2pop_mean(amostra1, amostra2, var_equal = T, sig_level = g, alternative = "greater")
...
Suponha que um pesquisador precisa decidir entre as hipóteses H~0~: &mu;~1~ - &mu;~2~ = 0 contra H~1~: &mu;~1~ - &mu;~2~ &#8800; 0. Assuma que as variâncias das populações são iguais. Algumas informações sobre este teste de hipóteses está na tabela abaixo. Complete e assinale corretamente as informações.
