...
* A estatística de teste (X^2^~0~) é:
...
* A estatística de teste (X^2^~0~) é: `r f(sol[1])`.
* A região crítica é dada por: (0;`r f(fit_correto$critical_vale[1] |> round(3))`)&#8746;(`r f(fit_correto$critical_vale[2] |> round(3))`; &#8734;).
* 
* 
* `r ifelse(fit_correto$statistic[1] < fit_correto$critical_vale[1] | fit_correto$statistic[2] > fit_correto$critical_vale[2], glue("Falso, pois ao nível de significância &gamma; = {g}, rejeitamos a hipótese nula."), "Verdadeiro.")`
* `r ifelse(fit_correto$statistic[1] < fit_correto$critical_vale[1] | fit_correto$statistic[2] > fit_correto$critical_vale[2], "Verdadeiro.", glue("Falso, pois ao nível de significância &gamma; = {g}, não rejeitamos a hipótese nula."))` 
