...
# ================================================================================
# lendo os dados
sheet_id = "1fcSg1y8cRfPEcW1ybEfNUC_etCbi5v3xsL8voP8ISSc"
...
📣📣📣Atenção! Segunda-feira, dia 24/01/2025, às 13h é a primeira aula do curso:  *`python` para Ciência de Dados: Exploração e Visualização de Dados*.\n
